 ...
 * Description: Internet Banking Online Payment Gateway using Malaysia saving and current account via FPX | Developed by Konsortium ICT Pantai Timur (formerly known as K-ICT). Contact <a href="https://www.k-ict.org/v4/contact-us" target="KICTwindow">sales@k-ict.org</a> for further details.
 * Author: K-ICT
...
{ # Function KPG_gateway_load start.
	...
	{ # Class KPG_gateway start.
		...
		{ # The class constructor start.
			...
			$this->KPG_greenbar_GoogleChrome="Green bar in Google Chrome";
			$this->KPG_greenbar_MozillaFirefox="Green bar in Mozilla Firefox";
			$this->KPG_security_notice='<div style="color:#a00;font-size:15px;font-weight:bold;">
			...
			<p><img alt="'.$this->KPG_greenbar_GoogleChrome.'" src="'.plugins_url("images/EVSSLGoogleChrome.jpg",__FILE__).'"> '.$this->KPG_greenbar_GoogleChrome.'</p>
			<p><img alt="$this->KPG_greenbar_MozillaFirefox" src="'.plugins_url("images/EVSSLMozillaFirefox.jpg",__FILE__).'"> '.$this->KPG_greenbar_MozillaFirefox.'</p>
